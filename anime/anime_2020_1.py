...
class DarwinsGameDownload(Winter2020AnimeDownload):
    ...
    def download_bluray(self):
        ...
        image_objs = [
            ...
            {'name': 'bd_5_1', 'url': 'https://pbs.twimg.com/media/EdXLxr4U0AA6U4F?format=jpg&name=4096x4096'},
            {'name': 'bd_5_2', 'url': 'https://pbs.twimg.com/media/EdXL0KUUMAEMTI7?format=jpg&name=4096x4096'},
            {'name': 'bd_6_1', 'url': 'https://pbs.twimg.com/media/EgRFzjvVoAAb9As?format=jpg&name=4096x4096'},
            {'name': 'bd_6_2', 'url': 'https://pbs.twimg.com/media/EgRF1SWVoAADj1S?format=jpg&name=4096x4096'},
...
class InfiniteDendrogramDownload(Winter2020AnimeDownload):
    ...
    folder_name = 'infinite-dendrogram'
...
class IshuzokuReviewersDownload(Winter2020AnimeDownload):
    ...
    folder_name = 'ishuzoku-reviewers'
