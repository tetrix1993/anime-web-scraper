...
def run():
    ...
    downloads = [ReZero2Download(), AssaultLilyDownload(), GochiUsa3Download(), Higurashi2020Download(),
                 JujutsuKaisenDownload(), KamisamaNiNattaHiDownload(), KamihiroDownload(), MaesetsuDownload(),
