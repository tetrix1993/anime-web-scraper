...
def run():
    migrate.run()
    downloads = [RailgunTDownload(), Kaguyasama2Download(), PriconneDownload()]
    downloads += [HxErosDownload(), KanokariDownload(), MaohgakuinDownload(), MonIshaDownload(), PeterGrillDownload(),
