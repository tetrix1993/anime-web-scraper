...
def migrate_folders():
    ...
    migrate_folder_by_name(UNCONFIRMED_DIR, '2022-3', 'isekai-yakkyoku')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2022-4', 'futoku-no-guild')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2022-4', 'renai-flops')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2022-4', 'fuukoi')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'inuhiro')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2022-4', 'akibamaidwar')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2022-4', 'diy')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'kubosan')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'ayakashi-triangle')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'maohgakuin2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'otonarino-tenshisama')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'ankokuheishi')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'tenten-kakumei')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'spyroom')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'otonariniginga')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-1', 'bofuri2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'watayuri')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'iseleve')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'masamune2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'oshinoko')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'yuushagashinda')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'yamada999')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'isenido')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'level1')
    migrate_folder_by_name('2023-2', '2023-3', 'shiroseijyo')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'liarliar')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'tonikawa2')
    migrate_folder_by_name('2023-2', '2023-3', 'masamune2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-2', 'onekillsister')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'frieren')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'eiyukyoushitsu')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'temple')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'matoslave')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'yumemirudanshi')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'tearmoon')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'wataoshi')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'dekoboko-majo')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'dungeon-meshi')
    migrate_folder_by_name('2023-3', UNCONFIRMED_DIR, 'tsuyosaga')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'lv1room')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-3', 'jitsuoresaikyo')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'hoshitele')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'shy')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'hyakkano')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'dosankogal')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-2', 'dainanaoji')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'kusuriya')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'kimizero')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'butaliver')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'seikengakuin')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'akuyakulv99')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'goblin-slayer2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2023-4', 'seijyonomaryoku2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'kekkonyubiwa')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'chiyumahou')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'saijakutamer')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'mofunade')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-3', 'roshidere')
    migrate_folder_by_name('2024-2', '2024-3', 'roshidere')
    migrate_folder_by_name('2024-1', '2024-2', 'sasakoi')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-1', 'sasapi')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-2', 'yozakurasan')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-2', 'unnamedmemory')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-2', 'hensara')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-2', 'spicewolf')
    ...
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-3', 'atri')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2024-3', 'gijiharem')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2025-2', 'slime300-2')
    migrate_folder_by_name(UNCONFIRMED_DIR, '2025-3', 'tsuyosaga')
